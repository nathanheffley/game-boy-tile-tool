...
const copyToClipboard = () => {
    let output = 'unsigned char ' + tilesetName.value + '[] =\n{\n    '
...
<template>
    <div class="p-4 flex flex-col items-start gap-4">
        <div class="flex gap-4">
            ...
            <div class="max-h-[203px] overflow-y-scroll flex flex-col gap-2">
                <div v-for="(s, index) in allSprites" class="border-2 border-gray-200">
